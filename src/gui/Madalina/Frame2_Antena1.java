	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Luni fr_a1 = new Frame3_Antena1_Luni();
				fr_a1.NewScreen();
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Marti fr = new Frame3_Antena1_Marti();
				fr.NewScreen();
				//frame.setVisible(false);
			}
		});
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Miercuri fr = new Frame3_Antena1_Miercuri();
				fr.NewScreen();
				//frame.setVisible(false);
			}
		});
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Joi fr = new Frame3_Antena1_Joi();
				fr.NewScreen();
				//frame.setVisible(false);
			}
		});
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Vineri fr = new Frame3_Antena1_Vineri();
				fr.NewScreen();
				//frame.setVisible(false);
			}
		});
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Sambata fr = new Frame3_Antena1_Sambata();
				fr.NewScreen();
				//frame.setVisible(false);
			}
		});
		...
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Frame3_Antena1_Duminica fr = new Frame3_Antena1_Duminica();
				fr.NewScreen();
				//frame.setVisible(false);
			}
		});
