...
public class Frame3_Antena1_Joi {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_Antena1_Joi window = new Frame3_Antena1_Joi();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 212, 464);
		...
		txtpnStirilePro_3.setText("20:30 Adela");
		...
		txtpnSurvivorRomania.setText("23:00 Observator");
		...
		txtpnVorbesteLumea_1.setBounds(10, 329, 129, 19);
		...
		txtpnCeSpun_1.setBounds(10, 358, 145, 19);
		...
		txtpnStirilePro_5.setBounds(10, 387, 106, 19);
		...
		btnNewButton.setBounds(126, 387, 67, 21);
