...
public class Frame3_Antena1_Miercuri {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_Antena1_Miercuri window = new Frame3_Antena1_Miercuri();
	 ...
	 */
	public Frame3_Antena1_Miercuri() {
		initialize();
	}
	...
	private void initialize() {
		...
		txtpnStirilePro_3.setText("20:30 Romania are roast");
		...
		txtpnStirilePro_4.setText("02:30 Rocky (R)");
		...
		txtpnFuriaUnui.setText("00:30 Incredibilul Hulk");
