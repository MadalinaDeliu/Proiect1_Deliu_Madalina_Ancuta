...
public class Frame3_Antena1_Vineri {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_Antena1_Vineri window = new Frame3_Antena1_Vineri();
	...
	private void initialize() {
		...
		txtpnStirilePro_3.setText("20:30 Escape plan");
		...
		txtpnSurvivorRomania.setText("22:30 iUmor (R)");
		...
		txtpnStirilePro_4.setText("03:15 Observator (R)");
		...
		txtpnFuriaUnui.setText("01:00 Robin Hood (R)");
		...
		btnNewButton.setBounds(126, 396, 67, 21);
