...
public class Frame3_KanalD_Marti {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_KanalD_Marti window = new Frame3_KanalD_Marti();
	...
	private void initialize() {
		...
		txtpnStirileKanal_1.setText("20:00 Fiica ambasadorului");
		...
		txtpnCasaIubirii_1.setText("23:00 Strada sperantei (R)");
		...
		txtpnDe.setText("01:30 Fiica ambasadorului (R)");
		...
		btnNewButton.setBounds(257, 475, 67, 21);
