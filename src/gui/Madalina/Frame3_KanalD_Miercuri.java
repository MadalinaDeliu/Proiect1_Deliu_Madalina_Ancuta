...
public class Frame3_KanalD_Miercuri {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_KanalD_Miercuri window = new Frame3_KanalD_Miercuri();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 278, 559);
		...
		btnNewButton.setBounds(193, 475, 67, 21);
