...
public class Frame3_ProTv_Marti {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_ProTv_Marti window = new Frame3_ProTv_Marti();
	...
	private void initialize() {
		...
		txtpnVorbesteLumea.setBounds(10, 39, 114, 19);
		...
		txtpnCeSpun.setBounds(10, 184, 114, 19);
		...
		txtpnFuriaUnui.setText("00:00 Contrabanda (R)");
		...
		txtpnSuperspeedr.setText("02:15 Lectii de viata (R)");
		...
		txtpnVorbesteLumea_1.setBounds(10, 349, 114, 19);
		...
		txtpnCeSpun_1.setBounds(10, 378, 147, 19);
