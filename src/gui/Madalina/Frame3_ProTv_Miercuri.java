...
public class Frame3_ProTv_Miercuri {
	...
	public static void NewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Frame3_ProTv_Miercuri window = new Frame3_ProTv_Miercuri();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 222, 464);
		...
		txtpnFuriaUnui.setText("00:00 Domino");
		txtpnFuriaUnui.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		txtpnFuriaUnui.setBounds(10, 218, 106, 19);
		...
		txtpnSuperspeedr.setBounds(10, 235, 106, 19);
		...
		txtpnVorbesteLumea_1.setBounds(10, 264, 114, 19);
		...
		txtpnImperiulLeilor.setText("21:30 Imperiul leilor");
