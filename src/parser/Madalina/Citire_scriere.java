...
public class Citire_scriere {
	public void read_json()
    {
        ...
        try {
            ...
            System.out.println("Numarul de posturi furnizate de firma de televiziune: \n" + firma.getNumar_posturi());
	...
	public void write_json()
	{
		...
		Emisiune emisiune = new Emisiune("Stiri", "cultural", 60, "20:30", 3, "Live");
		emisiuni.add(emisiune);
		Program_post_televiziune program = new Program_post_televiziune(1, 1, emisiuni);
		Post_televiziune post = new Post_televiziune("Kanal D", 1, "Luni", program);
		posturi.add(post);
